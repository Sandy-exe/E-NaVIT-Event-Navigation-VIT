...
class OrganiserApprovalPendingRequest extends StatefulWidget {
  ...
  @override
  State<OrganiserApprovalPendingRequest> createState() => _OrganiserApprovalPendingRequestState();
}

class _OrganiserApprovalPendingRequestState extends State<OrganiserApprovalPendingRequest> {
  late String role;
