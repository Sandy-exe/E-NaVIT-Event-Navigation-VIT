...
class NotificationService {
  ...
  Future<List<BellNotification>> getNotifications() async {
    ...
    notifications.addAll(notificationsList.map((notification) => BellNotification.fromJson(notification))
        .toList());
  ...
  static Future<void> onNotificationDisplayedMethod(
    ...
    BellNotification bellNotification = BellNotification(
      ...
      time: Timestamp.fromDate(receivedNotification.createdDate ?? DateTime.now()),
    );

    // Read the current user's notifications from secure storage
    String? currentUserDataJson = await secureStorage.reader(key: "currentUserData");
