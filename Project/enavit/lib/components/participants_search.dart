...
class _FloatingSearchBarWidgetApproverState extends State<FloatingSearchBarWidgetApprover> {
  ...
  Widget buildItem(BuildContext context, Users user) {
    ...
    final ApproverSearchModel model = Provider.of<ApproverSearchModel>(context, listen: false);
