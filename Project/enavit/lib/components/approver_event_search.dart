...
class FloatingSearchBarWidgetApproverEvent extends StatefulWidget {
  const FloatingSearchBarWidgetApproverEvent({super.key});

  @override
  State<FloatingSearchBarWidgetApproverEvent> createState() =>
      _FloatingSearchBarWidgetApproverEventState();
}

class _FloatingSearchBarWidgetApproverEventState extends State<FloatingSearchBarWidgetApproverEvent> {
          ...
          FloatingSearchBarAction(
            ...
            child: CircularButton(
              ...
              onPressed: () {
                ...
                services.getOrganizedEvents(context);
              },
            ),
          ),
  ...
  Widget buildItem(BuildContext context, Event event) {
    ...
    final ApproverEventSearchModel model =
