...
import 'package:enavit_main/pages/main_pages/general_pages/participant_orginzed_events.dart';
...
class _ViewProfileState extends State<ViewProfile> {
  ...
  Future removefromOrganiser(String eventId) async {
    ...
    if (currentUserData['role'] == 0) {
      Navigator.pop(context); // Pop the last route
