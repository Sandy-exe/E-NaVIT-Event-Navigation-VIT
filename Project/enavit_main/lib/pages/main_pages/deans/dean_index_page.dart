import 'package:enavit_main/pages/main_pages/approvers/approver_approve_publish_create_page.dart';
import 'package:enavit_main/pages/main_pages/deans/dean_club_create_edit_page.dart';
...
import '../../../components/dean_bottom_nav_bar.dart';
...
class DIndexPage extends StatefulWidget {
  const DIndexPage({super.key});

  @override
  State<DIndexPage> createState() => _DIndexPageState();
}

class _DIndexPageState extends State<DIndexPage> {
