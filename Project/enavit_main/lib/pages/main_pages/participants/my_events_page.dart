...
import 'package:enavit_main/components/date_picker.dart';
import 'package:enavit_main/components/event_timeline.dart';
  ...
  Future<void> updateFilter(String dropdownValue) async {
    ...
    if (dropdownValue == 'Week') {
      ...
      Provider.of<Compute>(context, listen: false)
          .datePickerMonth(now.month.toInt() - 1);
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 100, child: DatePicker()),
              const SizedBox(
                height: 20,
              ),
              Container(
